...
//
//     final newsModelHome = newsModelHomeFromJson(jsonString);

import 'dart:convert';

NewsModelHome newsModelHomeFromJson(String str) =>
    NewsModelHome.fromJson(json.decode(str));

String newsModelHomeToJson(NewsModelHome data) => json.encode(data.toJson());
...
class NewsModelHome {
  ...
  factory NewsModelHome.fromJson(Map<String, dynamic> json) => NewsModelHome(
    status: json["status"],
