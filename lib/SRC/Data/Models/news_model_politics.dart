...
//
//     final newsModelPolitics = newsModelPoliticsFromJson(jsonString);

import 'dart:convert';

NewsModelPolitics newsModelPoliticsFromJson(String str) =>
    NewsModelPolitics.fromJson(json.decode(str));

String newsModelPoliticsToJson(NewsModelPolitics data) =>
    json.encode(data.toJson());

class NewsModelPolitics {
  final String status;
  ...
  factory NewsModelPolitics.fromJson(Map<String, dynamic> json) =>
      NewsModelPolitics(
        status: json["status"],
...
final itemTypeValues = EnumValues({"Article": ItemType.ARTICLE});

enum Kicker { CONGRESSIONAL_MEMO, EMPTY, WHITE_HOUSE_MEMO }

final kickerValues = EnumValues({
  "Congressional Memo": Kicker.CONGRESSIONAL_MEMO,
  "": Kicker.EMPTY,
  "White House Memo": Kicker.WHITE_HOUSE_MEMO,
});
...
final sectionValues = EnumValues({"us": Section.US});
