...
import 'package:news_app/SRC/Presentation/Widgets/Auth/Login/forget_password.dart';
...
class CommonUi extends StatefulWidget {
  const CommonUi({super.key, required this.buttontext});

  @override
  State<CommonUi> createState() => _LoginScreenState();

  final String buttontext;
}

class _LoginScreenState extends State<CommonUi> {
