...
class _NewsDetailPageState extends State<NewsDetailPage> {
  ...
  ValueNotifier<bool> isFavorite12 = ValueNotifier(false);
  ...
  late final Uri url = Uri.parse(widget.inDex?.url ?? "");
  ...
  Widget build(BuildContext context) {
    // Provider.of<FavoriteProviderController>(context, listen: false);
              ...
              child: Column(
                ...
                children: [
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              child: Text(
                                "${widget.inDex?.updatedDate?.hour} hours Ago ",
                                style: Theme.of(context).textTheme.bodySmall,
                              ),
                            ),
                          ],
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      child: Text(
                        widget.inDex?.multimedia?[0].caption ?? "",
                        style: Theme.of(context).textTheme.bodyMedium,
                      ),
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: Text(
                      widget.inDex?.multimedia?[0].copyright ?? "",
                      style: Theme.of(context).textTheme.bodyMedium,
                    ),
                  ),
                      ...
                      Row(
                        ...
                        children: [
                          ValueListenableBuilder(
                            valueListenable: isFavorite12,
                            builder: (context, value, child) {
                              return InkWell(
                                onTap: () {
                                  log(
                                    "The Before Value is fhte Notifer is ${isFavorite12.value}",
                                  );
                                  // isFavorite12.notifyListeners();
                                  isFavorite12.value = !isFavorite12.value;

                                  log(
                                    "The Update Value is fhte Notifer is ${isFavorite12.value} $value",
                                  );
                                },
                                child: Icon(
                                  isFavorite12.value
                          ...
                          // Consumer<FavoriteProviderController>(
                          //   builder: (context, value, child) {
                          //     return GestureDetector(
                          //       onTap: () {
                          //         log(
                          //           "The Before Value is fhte Notifer is ${value.isFavorite}",
                          //         );
                          //         // isFavorite12.notifyListeners();
                          //         // isFavorite12.value = !isFavorite12.value;
                          //         value.favorite();
                          //
                          //         log(
                          //           "The Update Value is fhte Notifer is ${value.isFavorite} ",
                          //         );
                          //       },
                          //       child: Icon(
                          //         value.isFavorite
                                  ...
                                  showDialog(
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        ...
                                        title: Text(
                                          'Do you want to delete or remove from Bookmark !! ❌',
                                        ),
                                        titleTextStyle: Theme.of(
                                          context,
                                        ).textTheme.bodyMedium,
                                              ...
                                              onTap: () async {
                                                if (snapshot.exists) {
                                                  for (final child
                                                    ...
                                                    await databaseRef
                                                        .child(child.key!)
                                                        .remove(); // ✅ only removes the matching record
                                                  }
                                                  isBookmark.value = false;
                                                  if (!context.mounted) return;
                                                  Navigator.pop(context);
                                                  ...
                                                  showDialog(
                                                    ...
                                                    builder: (context) {
                                                      return AlertDialog(
                                                        ...
                                                        title: Text(
                                                          'delete or remove from Bookmark is cancel ! ❌',
                                                        ),
