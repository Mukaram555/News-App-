            ...
            return [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                    'Today ${DateTime.timestamp().day}/${DateTime.now().month}/${DateTime.now().year}',
                  ),
                ),
              ),
              SliverList.builder(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DetailsNotification(),
                          ),
                        );
                      },
                      child: Container(
            ...
            slivers: [
              SliverToBoxAdapter(
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                    'yesterday ${DateTime.timestamp().day}/${DateTime.now().month}/${DateTime.now().year}',
                  ),
                ),
              ),
