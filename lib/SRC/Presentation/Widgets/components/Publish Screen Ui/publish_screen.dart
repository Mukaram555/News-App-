...
class _PublishScreenState extends State<PublishScreen> {
  ...
  String? Function(String?)? NewsDetailsValidator = (String? value) {
    return value!.isEmpty || value.length >= 255  ? 'Please Enter News Details or mix 255 lenght' : null;
  };
  ...
  String? Function(String?)? NewsAbtrictionValidator = (String? value) {
    return value!.isEmpty || value.length >= 255 ? 'Please Enter News Abtriction or mix 255 lenght' : null;
  };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Create News', style: Theme.of(context).textTheme.labelSmall?.copyWith(color:Theme.of(context).colorScheme.onSurface ),),
                  IconButton(onPressed: (){
                          ...
                          return GestureDetector(
                            onTap: (){
                              ...
                              showDialog(context: context, builder:(_) {
                                ...
                                return AlertDialog(
                                  ...
                                  title: Center(child: Text('Seclect Image Source')),
                                  content: Row(
                            ...
                            child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: value != null ? DecorationImage(image: FileImage(File(pickerImage.value!.path,)) ,fit: BoxFit.cover,): null,
                                    borderRadius: BorderRadius.circular(20),
                                  ),
                                  child:
                                   pickerImage.value != null  ? SizedBox.shrink():
                                  Center(
                                    child:Icon(Icons.add_a_photo_outlined,size: 70,)
                                  ),
                                ),
                      ...
                      builder: (context, selectedValues, child) {
                        return SizedBox(
                          ...
                          child: DropdownButtonFormField(
                            hint: Text('Select Topic', style: Theme.of(context).textTheme.labelSmall?.copyWith(color : Theme.of(context).colorScheme.onSurface),),
                            ...
                            items: List.generate(
                                ...
                                (index)=>
                                  ...
                                  value: index,
                                  child: Text(
                                  TopicsModelData[index].topicsName, style: Theme.of(context).textTheme.labelSmall?.copyWith(color : Theme.of(context).colorScheme.onSurface),)
                                  ) ), onChanged: (int? value) {
                              if (kDebugMode) {
      ...
      bottomNavigationBar: Padding(padding: EdgeInsets.only(bottom: 15.0.h, right: 15.0.w),
      child: SizedBox(
        height: 50.0.h,
          ...
          children: [
            ...
            GestureDetector(
                onTap: () async {
                  ...
                  if (kDebugMode) {
                    print("========== validate ==================== ${selectedValue.value} == ${TopicsModelData[selectedValue.value].topicsName}");
                  }

                   ref.push().set(
                    Result(
                      section: TopicsModelData[selectedValue.value].topicsName,
                      subsection: '',
                      title: newsTile.text,
                   ...
                   return showDialog(
                    ...
                    builder: (dialogCtx) => AlertDialog(
                      icon: Icon(Icons.check_box, size: 70, color: Colors.green),
